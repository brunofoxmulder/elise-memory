...
Google credentials and canonical workbook IDs are private runtime configuration.
A synchronization configuration error must never prevent the app from starting.
"""
...
def sync_runtime_status() -> dict:
    """Return non-sensitive synchronization readiness information."""
    ...
    missing_sources = missing_canonical_source_ids()
    sources_configured = not missing_sources
    return {
        "enabled": enabled,
