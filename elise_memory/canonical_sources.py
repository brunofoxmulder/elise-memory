...
approved sheet names and ranges; it performs no Drive discovery.
"""
import os
...
def canonical_ranges() -> dict[str, SheetRange]:
    """Return the approved canonical ranges using private workbook IDs."""
    return {
        "metier": SheetRange(
...
def missing_canonical_source_ids() -> list[str]:
    """Return missing private configuration keys, without exposing values."""
    return [
        env_name
